...
st.set_page_config(page_title="University Attendance System", page_icon="📚", initial_sidebar_state="expanded")
from streamlit_authenticator.utilities.hasher import Hasher
hashed_passwords = Hasher(['gagan@123', 'def']).generate()
...
name, authentication_status, username= authenticator.login('main', fields = {'Form name': 'Login Form'})
